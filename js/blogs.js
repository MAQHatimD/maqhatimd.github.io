...
"use strict";
var oBlogsPager = {
    template: '<div style="margin-top: 7vh;"><div class="post-meta"><span>@date</span></div><div class="post-header"><a href="@href"><h2>@title</h2></a></div><!--<div class="post-media"><img alt="Blogs" title="@tooltip" src="@Blogsimagesrc">--></div><div class="blogpost-entry">@content</div><p class="blog-ellipsis"></p><a href="@href1" class="readmoreblog">Read more</a></div>',
    pageIndex: 0,
    pagesize: 6
